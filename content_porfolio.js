    ...
    <ul class="developing-ul">
        ...
        <li>
            <a href="https://vitaliytom-rs2020q1-presentation.netlify.app" target="_blank"
                rel="noopener noreferrer">"presentation" - linux kernel</a>
        </li>
        <li>
...
<li class="developing-li">
    <span class="course">
        Application "Animals" was made within the java course in
    
    <a href="https://teachmeskills.by/">&lt;TeachMeSkills/&gt;</a>
    </span>
    <ul class="developing-ul">
        <li>
...
<li class="developing-li">
    ...
    <ul class="developing-ul">
        ...
        <li>
            <a href="https://github.com/VitaliyTom/student/tree/master/src/com/company/students" target="_blank"
                rel="noopener noreferrer">"Students" on GitHub</a>
        </li>
    </ul>
</li>`,
